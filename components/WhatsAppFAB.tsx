...
export default function WhatsAppFAB({
  phoneNumber,
  message = "Hi! I'd like to schedule a free in-home assessment for HVAC or Water Purification services.",
}: WhatsAppFABProps) {
  ...
  return (
    <motion.div
      ...
      transition={{ type: "spring", stiffness: 200, damping: 18, delay: 2.5 }}
    ...
    >
      <motion.a
        ...
        style={{
          ...
          boxShadow: "0 8px 32px rgba(37,211,102,0.45), 0 4px 12px rgba(37,211,102,0.25)",
        }}
      >
        {/* Pulse rings */}
        <span
      ...
      >
        <div
          className="whitespace-nowrap px-4 py-2 rounded-xl font-display font-700 text-sm text-white shadow-xl"
